...
const Hero = () => {
  ...
  return (
    <section
    id="home"
    className="w-[100%] my-auto flex xl:flex-row flex-col justify-center
    min-h-screen gap-10 max-container">
    <div className="relative xl:w-2/5 flex flex-col justify-center items-start
    w-full  max-xl:padding-x pt-28">
    <p className="text-xl font-montserrat text-[#3378FF]">Summer Collection</p>
    ...
    <br/>
    <span className="text-[#3378FF] inline-block mt-3 ">Adidas</span> Shoes 
             
    </h1>
     <p className="font-montserrat text-slate-gray 
     tex-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover stylish adidas New Arrivals, quality comfort with greatest Innvoations for your active life.</p>
      ...
      flex-wrap w-full mt-20 gap-16">
         {statistics.map((stat, index) => (
          <div key={index}>
            ...
            <p className="leading-7 font-montserrat text-[#3378FF] font-semibold">{stat.label}</p>
            </div>
         ))}
      </div>
    </div>
